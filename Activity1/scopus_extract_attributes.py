...
Granted_Awards = ['Institution_Grants_top_1', 'Institution_Grants_top_2', 'Institution_Grants_top_3',
                  'Institution_Grants_top_4', 'Institution_Grants_top_5', 'Awarded_Grants_top_1',
                  'Awarded_Grants_top_2', 'Awarded_Grants_top_3',
    ...
    if not re.search(r'.DS_Store\b', lists[i]):
        ...
        for j in range(len(lists2)):
            ...
            if re.search(r'-Analyze-Country\b', lists2[j]):
                ...
                country = pd.read_csv('/Users/jesusllanogarcia/Downloads/Scopus/{}/{}'.format(lists[i], lists2[j]),
            ...
            if re.search(r'Scopus_exported_refine_values\b', lists2[j]):
                df1 = pd.read_csv('/Users/jesusllanogarcia/Downloads/Scopus/{}/{}'.format(lists[i], lists2[j]),
            ...
            if re.search(r'-Analyze-Affiliation\b', lists2[j]):
                Aff = pd.read_csv('/Users/jesusllanogarcia/Downloads/Scopus/{}/{}'.format(lists[i], lists2[j]),
                                  error_bad_lines=False,
                                  skiprows=7)
            ...
            if re.search(r'-Analyze-FundingSponsor\b', lists2[j]):
                Funding = pd.read_csv('/Users/jesusllanogarcia/Downloads/Scopus/{}/{}'.format(lists[i], lists2[j]),
                                      error_bad_lines=False,
                                      skiprows=7)
